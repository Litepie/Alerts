...
class AlertsServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind('alerts', function ($app) {
            return $this->app->make('Litepie\Alerts\Alerts');
        });

        // Bind Notification to repository
        $this->app->bind(
            'Litepie\Alerts\Interfaces\NotificationRepositoryInterface',
            \Litepie\Alerts\Repositories\Eloquent\NotificationRepository::class
        );

        $this->app->register(\Litepie\Alerts\Providers\AuthServiceProvider::class);
        $this->app->register(\Litepie\Alerts\Providers\RouteServiceProvider::class);
    }
